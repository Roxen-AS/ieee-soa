...
export default function Navbar() {
  ...
  return (
    <>
      {/* TOP BAR + PILL — single sticky block, no gap */}
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display:"flex", alignItems:"center", gap:12 }}>
            ...
            <button
              ...
              onClick={() => setOpen(o => !o)}
              style={{ flexDirection:"column", gap:6, cursor:"pointer", padding:10, background:"none", border:"none" }}
            >
        ...
        {/* Pill nav — inside same sticky block, flush below top row */}
        <div style={{
