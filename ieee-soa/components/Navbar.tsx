...
export default function Navbar() {
  ...
  return (
    <>
      <nav style={{
        position:"sticky", top:0, zIndex:500, height:58,
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10 }}>
          ...
          >
            <div style={{
              ...
              <div style={{
                ...
                transform: dark ? "none" : "translateX(16px)",
          ...
          >
            ...
            style={{
              ...
              letterSpacing:2, textTransform:"uppercase", padding:"8px 18px",
          ...
          {LINKS.map(l => (
            <Link
              ...
              style={{
                ...
                color: isActive(l.href) ? "#0A0E1A" : "rgba(255,255,255,0.52)",
